 ...
 */
final class Version20220204160321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles CHANGE idcategorie idcategorie VARCHAR(255) NOT NULL, CHANGE idconsole idconsole VARCHAR(255) NOT NULL, CHANGE title title VARCHAR(1000) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE articles CHANGE title title VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE idcategorie idcategorie INT NOT NULL, CHANGE idconsole idconsole INT NOT NULL');
